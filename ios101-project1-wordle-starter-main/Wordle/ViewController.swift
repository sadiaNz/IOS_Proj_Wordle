...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        keyboardController.didSelectString = { [weak self] selectedString in
            ...
            // END YOUR CODE HERE
            customizeCollectionViewAppearance(collectionView: wordsCollectionView)
            customizeCollectionViewAppearance(collectionView: keyboardCollectionView)
        }
        // Additional: Function to customize UICollectionView appearance
        func customizeCollectionViewAppearance(collectionView: UICollectionView) {
            collectionView.backgroundColor = .clear
            // Add any other visual enhancements as needed
        }
    }
}
